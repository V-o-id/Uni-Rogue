...
public class Grid {
    ...
    /**
     * Returns a random number in a specific range (e.g. input = 1 return 1 - 10, input = 2 return 11 - 19)
     * @param input number defines random number range
     */
    ...
    /**
     * Returns a random postion in the room
     * @param roomNumber defines the rooms
     */
